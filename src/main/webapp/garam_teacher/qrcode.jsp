	...
	<div class="mXY">
		<div class="qrcode">
			<div class="qrimg" style="padding: 0">
				...
				File path = new File(application.getRealPath("/") + "garam_teacher/qrImages/");
				...
				%>
				<img
					src="<%=request.getContextPath() + "/garam_teacher/qrImages/" + savedFileName + ".png"%>">
			</div>
			<span>잔여횟수</span>
			<div class="count" id="txtHint">
				<b>4</b>회
			</div>
		</div>
